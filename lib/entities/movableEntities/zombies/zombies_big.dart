...
class ZombieBig extends Zombie {

  final double movementSpeed = 15;
  final Vector2 _hitboxRelation = Vector2(0.5, 1);


  ZombieBig(srcX, srcY, int hp, RoomArea roomArea) : super(srcX, srcY, hp, roomArea);
  ...
  Future<void> setupAnimations() async {
    ...
    animation = SpriteAnimation.spriteList([
      await Sprite.load("BigZombieRun1.png"),
      await Sprite.load("BigZombieRun2.png"),
      await Sprite.load("BigZombieRun3.png"),
      await Sprite.load("BigZombieRun4.png")
    ], stepTime: 0.4);
